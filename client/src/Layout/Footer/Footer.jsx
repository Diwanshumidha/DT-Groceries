    ...
    <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        >
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-white">Customer Care</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-medium text-white">Terms And Condition</p>
            ...
            <ul className="mt-8 space-y-4 text-sm">
              <li>
                ...
                >
                  ...
                  <span className="flex-1 text-white">@gmail.com</span>
                </a>
              </li>
      ...
      <div className="mt-12 Footer_bottom pt-6">
        <div className="text-center sm:flex sm:justify-between sm:text-left">
          <p className="text-sm text-white">
            <span className="block sm:inline">En</span>
            <span className="block sm:inline">Usd</span>
